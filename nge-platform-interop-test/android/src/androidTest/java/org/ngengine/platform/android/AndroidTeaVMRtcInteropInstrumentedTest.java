...
public class AndroidTeaVMRtcInteropInstrumentedTest {
    ...
    public void androidAndTeaVmBrowserCanExchangeMessagesOverRtc() throws Exception {
        ...
        try {
            ...
            Assume.assumeNoException("Skipping Android/TeaVM RTC interop test: runtime unavailable", t);
            return;
        }
        ...
        RTCTransport transport = platform.newRTCTransport(p2pAttemptTimeout, "android-teavm-interop", STUN_SERVERS);
        ...
        try {
            ...
            answerMsg.addProperty("to", "browser");
            ...
            responderDefaultChannelTaskRef.compareAndSet(
                null,
                transport.createDataChannel(BROWSER_INITIATOR_CHANNEL, null, true, true, 0, null)
            );
            ...
            metaMsg.addProperty("to", "browser");
            ...
            readyMsg.addProperty("to", "browser");
            readyMsg.addProperty("type", "android-ready");
            postJson(http, signalBase + "/send", readyMsg);

            awaitNoListenerError(listenerError, "waiting for browser-ready");
