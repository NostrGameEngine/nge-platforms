        ...
        while (1) switch (_context27.n) {
          ...
          case 1:
            ...
            return _context27.a(2, {
              ...
              bodyBase64: _scure_base__WEBPACK_IMPORTED_MODULE_5__.base64.encode(respBody)
            });
        }
      }, _callee27);
    }));
...
var fetchAsync = function fetchAsync(method, url, headers, body, timeoutMs, res, rej) {
  fetchPromise(method, url, headers, body, timeoutMs).then(function (response) {
    return res(response.status, response.headers, response.bodyBase64);
  })["catch"](function (error) {
